    ...
    return (
        ...
        >
            ...
            >
                {title || (
                    <span>
                        This is the best site ever to learn DSA. <br /> No kidding.
                    </span>
                )}
            </motion.h2>
            {/* Lid */}
            ...
            >
                ...
                >
                    <span className="text-white">
                        <Avatar>
                            <AvatarImage src="/logo.png" alt="Source Code" className="dark:invert" sizes="30" />
                            <AvatarFallback>AlgoEspresso</AvatarFallback>
                        </Avatar>
                    </span>
                </div>
            </div>
